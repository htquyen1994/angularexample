...
@Component({
    ...
    template: `
        <div *ngIf="fullScreen;else windowed">
            <div *ngIf="visible"  #mask [ngClass]="{'p-galleria-mask p-widget-overlay':true, 'p-galleria-visible': this.visible}" [class]="maskClass" [ngStyle]="{'zIndex':zIndex}">
...
@Component({
    ...
    template: `
        <div [attr.id]="id" *ngIf="galleria.value && galleria.value.length > 0" [ngClass]="{'p-galleria p-widget': true, 'p-galleria-fullscreen': this.galleria.fullScreen,
            ...
            <button *ngIf="galleria.fullScreen" type="button" class="p-galleria-close p-link p-widget p-state-default p-corner-all" (click)="maskHide.emit()">
...
@Component({
    ...
    template: `
        <div class="p-galleria-item-container">
            <button *ngIf="showItemNavigators" type="button" [ngClass]="{'p-galleria-item-prev p-galleria-item-nav p-link': true, 'p-state-disabled': this.isNavBackwardDisabled()}" (click)="navBackward($event)"
                [disabled]="isNavBackwardDisabled()">
                <span class="p-galleria-item-prev-icon pi pi-chevron-left"></span>
            </button>
            <p-galleriaItemSlot type="item" [item]="activeItem" [templates]="templates" class="p-galleria-item"></p-galleriaItemSlot>
            <button *ngIf="showItemNavigators" type="button" [ngClass]="{'p-galleria-item-next p-galleria-item-nav p-link': true,'p-state-disabled': this.isNavForwardDisabled()}" (click)="navForward($event)"
        ...
        <ul *ngIf="showIndicators" class="p-galleria-indicators p-helper-reset">
            <li *ngFor="let item of value; let index = index;" tabindex="0"
                (click)="onIndicatorClick(index)" (mouseenter)="onIndicatorMouseEnter(index)" (keydown.enter)="onIndicatorKeyDown(index)"
                [ngClass]="{'p-galleria-indicator': true,'p-state-highlight': isIndicatorItemActive(index)}">
    ...
    `,
    host: {
        '[class.p-galleria-item-wrapper]': 'true',
    },
    changeDetection: ChangeDetectionStrategy.Default
})
    ...
    template: `
        <div class="p-galleria-thumbnail-wrapper">
            <div class="p-galleria-thumbnail-container">
                <button *ngIf="showThumbnailNavigators" [ngClass]="{'p-galleria-thumbnail-prev p-link': true, 'p-state-disabled': this.isNavBackwardDisabled()}" (click)="navBackward($event)" [disabled]="isNavBackwardDisabled()">
                ...
                <button *ngIf="showThumbnailNavigators" [ngClass]="{'p-galleria-thumbnail-next p-link': true, 'p-state-disabled': this.isNavForwardDisabled()}" (click)="navForward($event)" [disabled]="isNavForwardDisabled()">
